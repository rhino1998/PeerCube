...
\begin{document}
	\resizebox{\columnwidth}{!}{
		...
		\begin{tikzpicture}[scale=1]
			\begin{axis}[
			title={\caption{Mean 95th Percentile Latency\\(Unmodified)}\label{graph:DefaultMean95L}}, 
			title style={yshift=2.5ex,text width=8cm, align=center},
				...
				bar width=6pt,
				xtick=data,
				xticklabels from table={\defaultAVG}{Config},
				ymin=0,
				xmin=-1,
			...
			\addplot[style={bblue,fill=bblue}] table [x expr=\coordindex,y=m595L,col sep=comma] {\defaultAVG};
			\addplot[style={ggreen,fill=ggreen}] table [x expr=\coordindex,y=m1095L,col sep=comma] {\defaultAVG};
			\addplot[style={rred,fill=rred}] table [x expr=\coordindex,y=m2095L,col sep=comma] {\defaultAVG};
			\foreach \i in {0,1,...,3}{ % category loop
				\pgfplotstablegetelem{\i}{m095L}\of\defaultAVG
				\pgfmathsetmacro{\ya}{\pgfplotsretval}
				\pgfplotstablegetelem{\i}{m595L}\of\defaultAVG
				\pgfmathsetmacro{\yb}{\pgfplotsretval}
				\pgfplotstablegetelem{\i}{m1095L}\of\defaultAVG
				\pgfmathsetmacro{\yc}{\pgfplotsretval}
				\pgfplotstablegetelem{\i}{m2095L}\of\defaultAVG
