...
\begin{document}
	\resizebox{\columnwidth}{!}{
		...
		\begin{tikzpicture}[scale=1]
			\begin{axis}[
			title={\caption{Mean 95th Percentile Latency\\(Paging)}\label{graph:PageMean95L}}, 
			...
			\addplot[style={ppurple,fill=ppurple}] table [x expr=\coordindex,y=m095L,col sep=comma] {\pagingAVG};
			\addplot[style={bblue,fill=bblue}] table [x expr=\coordindex,y=m595L,col sep=comma] {\pagingAVG};
			\addplot[style={ggreen,fill=ggreen}] table [x expr=\coordindex,y=m1095L,col sep=comma] {\pagingAVG};
			\addplot[style={rred,fill=rred}] table [x expr=\coordindex,y=m2095L,col sep=comma] {\pagingAVG};
			\foreach \i in {0,1,...,3}{ % category loop
				\pgfplotstablegetelem{\i}{m095L}\of\pagingAVG
				\pgfmathsetmacro{\ya}{\pgfplotsretval}
				\pgfplotstablegetelem{\i}{m595L}\of\pagingAVG
				\pgfmathsetmacro{\yb}{\pgfplotsretval}
				\pgfplotstablegetelem{\i}{m1095L}\of\pagingAVG
				\pgfmathsetmacro{\yc}{\pgfplotsretval}
				\pgfplotstablegetelem{\i}{m2095L}\of\pagingAVG
